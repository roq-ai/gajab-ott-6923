...
function ContentListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ContentInterface[]>(
    ...
    () =>
      getContents({
        relations: ['provider', 'review.count', 'watchlist.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('watchlist', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>watchlist</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
