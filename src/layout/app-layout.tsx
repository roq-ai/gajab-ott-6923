...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'account-owner', 'content-creator', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Content', path: '/contents', entity: 'content', service: AccessServiceEnum.PROJECT, icon: FiFilm },
    { name: 'Promotion', path: '/promotions', entity: 'promotion', service: AccessServiceEnum.PROJECT, icon: FiGift },
